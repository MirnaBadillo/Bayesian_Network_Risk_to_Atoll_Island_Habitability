...
CP_Risk_to_MALE_Habitability <- Risk_to_MALE_Habitability_array(Risk_to_Habitability_levels, Risk_to_Land_levels, Risk_to_freshwater_levels, Risk_to_Foodsupply_levels, Risk_to_Settlement_levels, Risk_to_Economic_opportunities_levels) 
...
density_data_2050_26_M <- data.frame(Risk_level = rep(Risk_to_Habitability_levels, Scenarios_2050_df_M$Probability[1:101] * 5000))
density_data_2050_85_M <- data.frame(Risk_level = rep(Risk_to_Habitability_levels, Scenarios_2050_df_M$Probability[102:202] * 5000))
