...
Query_Risk_to_habitability_2090_RCP26_scenario_LW <- Query_function_scenario_LW("Risk_to_MALE_Habitability", "MALE", 2090, 2.6,  dfit)
Query_Risk_to_habitability_2090_RCP85_scenario_LW <- Query_function_scenario_LW("Risk_to_MALE_Habitability", "MALE", 2090, 8.5,  dfit)
